...
On challenge description we got an information in UPPERCASE LETTERS. RSA
...
First of all, we need to remove all spaces on Public and Private keys
...
I found new site and i used inspect element to get this information on source.
